 ...
 */
enum KW_TYPE {
    KW_MODULE, KW_USING, KW_DEF, KW_REDEF, KW_EXTERN, KW_ABSTRACT, KW_STATIC, KW_TPE, KW_CLASS,
...
enum OPER_TYPE {
    ...
    OPER_EQ, OPER_PLUS_EQ, OPER_MINUS_EQ, OPER_TIMES_EQ, OPER_DIV_EQ, OPER_MOD_EQ,
        OPER_POW_EQ, OPER_B_AND_EQ, OPER_B_OR_EQ, OPER_L_SHIFT_EQ, OPER_R_SHIFT_EQ, // ASSIGNMENT OPERATORS
